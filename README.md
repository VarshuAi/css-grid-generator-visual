...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/VARSHAN69/css-grid-generator-visual.git
   cd css-grid-generator-visual
   ```
...
[![Repo](https://img.shields.io/badge/css-grid-generator-visual-Repo-00CC66?style=for-the-badge&logo=github&logoColor=black)](https://github.com/VarshuAi/css-grid-generator-visual)
